  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button className=" rounded-full cursor-pointer gap-2 transition-all duration-300 ease-in-out disabled:cursor-not-allowed bg-primary text-white ">
          <div className="h-10 w-10 outline border-blue-600 outline-background border-2 border-primary rounded-full overflow-hidden flex items-center justify-center">
          <img alt="Нүүр зураг" width="40" height="40" decoding="async" data-nimg="1" src="./me.png" className="color: transparent;"></img>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" color="currentColor" className="absolute bottom-0 right-0 text-foreground h-4 w-4 rounded-full border border-border-tertiary bg-button-secondary-bg" stroke-width="1.5" stroke="currentColor"><path d="M5.99977 9.00005L11.9998 15L17.9998 9" stroke="currentColor" stroke-width="1.5"></path></svg>
          </div>
          </button>
